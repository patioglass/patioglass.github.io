...
$(function(){
    ...
    function main_loop() {
        ...
        if(fire_height < y && flag){
            ...
            $(".result_score").attr("href","http://twitter.com/intent/tweet?url=http://patio.bitbucket.org/summer2015/Wasshoi/index.html&amp;text="+count+"秒の間、 @"+viewModel.screen_name()+"をWasshoiした&amp;hashtags=Wasshoiぱちお夏の陣2015");
            flag = false;
        }
        judge();
